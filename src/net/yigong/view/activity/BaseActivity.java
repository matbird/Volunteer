...
import net.yigong.utils.ACache;
import net.yigong.utils.DialogUtil;
import net.yigong.utils.StringUtils;
import net.yigong.wedget.crouton.Crouton;
import net.yigong.wedget.crouton.Style;
import net.yigong.wedget.slideingactivity.IntentUtils;
import net.yigong.wedget.slideingactivity.SlidingActivity;
