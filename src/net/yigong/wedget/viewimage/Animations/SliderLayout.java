...
package net.yigong.wedget.viewimage.Animations;
...
import net.yigong.R;
import net.yigong.wedget.viewimage.Indicator.PagerIndicator;
import net.yigong.wedget.viewimage.SliderTypes.BaseSliderView;
import net.yigong.wedget.viewimage.Transformers.AccordionTransformer;
import net.yigong.wedget.viewimage.Transformers.BackgroundToForegroundTransformer;
import net.yigong.wedget.viewimage.Transformers.BaseTransformer;
import net.yigong.wedget.viewimage.Transformers.CubeInTransformer;
import net.yigong.wedget.viewimage.Transformers.DefaultTransformer;
import net.yigong.wedget.viewimage.Transformers.DepthPageTransformer;
import net.yigong.wedget.viewimage.Transformers.FadeTransformer;
import net.yigong.wedget.viewimage.Transformers.FlipHorizontalTransformer;
import net.yigong.wedget.viewimage.Transformers.FlipPageViewTransformer;
import net.yigong.wedget.viewimage.Transformers.ForegroundToBackgroundTransformer;
import net.yigong.wedget.viewimage.Transformers.RotateDownTransformer;
import net.yigong.wedget.viewimage.Transformers.RotateUpTransformer;
import net.yigong.wedget.viewimage.Transformers.StackTransformer;
import net.yigong.wedget.viewimage.Transformers.TabletTransformer;
import net.yigong.wedget.viewimage.Transformers.ZoomInTransformer;
import net.yigong.wedget.viewimage.Transformers.ZoomOutSlideTransformer;
import net.yigong.wedget.viewimage.Transformers.ZoomOutTransformer;
import net.yigong.wedget.viewimage.Tricks.FixedSpeedScroller;
import net.yigong.wedget.viewimage.Tricks.InfinitePagerAdapter;
import net.yigong.wedget.viewimage.Tricks.InfiniteViewPager;
import net.yigong.wedget.viewimage.Tricks.ViewPagerEx;
